...
ssize_t write(int fd, const void *buf, size_t nbyte){
    ...
    string output = "[logger] write(\"" + string(abs_path) + "\", \"" + string(buffer) + "\", " +to_string(nbyte) + ") = " + to_string(ans) + "\n";
    print(output);
...
size_t fread(void *ptr, size_t size, size_t nmemb, FILE *stream){
    ...
    string output = "[logger] fread(\"" + string(buffer) + "\", " + to_string(size) + ", " + to_string(nmemb) + ", \"" + string(abs_path) + "\") = " + to_string(ans) + "\n";
    print(output);
